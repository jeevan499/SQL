use inclass;
create view savings_account_details as                              # row view              
	select 	* 
    from 	bank_account_details 
	where 	account_type = "SAVINGS" and
			account_status = "ACTIVE";
            
create view row_column_subset_bank_view as                              # column and row view
select customer_id, Account_number, account_type, Balance_amount
	from bank_account_details where account_status = 'ACTIVE';
    
create or replace view cust_ac_balance_view as                           # group by view
