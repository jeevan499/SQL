...
## Full Join   , To create full join (left join union right join)
select 
	c.cust_id,
    c.cust_name,
    c.contact_name,
...
select e1.emp_id, e1.emp_name, e1.emp_desig, mgr.emp_name as Manager
...
## alternate way of writing this code (easy way)
